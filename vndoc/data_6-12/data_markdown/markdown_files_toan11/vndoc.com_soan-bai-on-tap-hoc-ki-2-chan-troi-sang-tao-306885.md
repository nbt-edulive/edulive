...
---|---|---  
**Điểm giống**|  \- Đều đề cập đến vấn đề cụ thể\- Có tính khách quan, sử dụng ngôn ngữ trang trọng, chuyên môn.\- Yêu cầu sử dụng các thông tin đáng tin cậy để hỗ trợ cho các yếu tố như tự sự, biểu cảm và nghị luận.  
